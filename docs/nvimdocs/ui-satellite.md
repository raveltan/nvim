...
- Broad `excluded_filetypes` covering trouble, oil, dap-view, noice, grug-far, diffview, fugitive, markview, codecompanion, avante — these own their own rendering and conflict with the satellite float.
